...
// sempre caía por cima da sidebar. `lg:left-[312px]` = 288px da sidebar +
// 24px de padding do conteúdo, alinhando com a borda esquerda real da área
// de conteúdo (achado ao vivo: o FAB aparecia em cima do menu lateral).
export function KanbanFab({ label, onClick }) {
  if (!onClick) return null;
  return (
    <button
      onClick={onClick}
      className="hidden lg:flex fixed bottom-6 lg:left-[312px] z-50 items-center gap-2 px-4 py-3 rounded-full font-semibold text-sm transition-all active:scale-95"
