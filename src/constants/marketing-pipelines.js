...
export const MARKETING_AUTOMATION_TEMPLATES = [
  {
    ...
    rule: {
      ...
      companyId: "all",
      module: "marketing",
      trigger: { type: "campaign_stage_change", stageId: "producao", days: 10 },
      action:  { type: "notify", message: "Campanha parada há 10 dias em Produção — verificar com equipe." },
    },
  },
  {
    id: "mkt-urgente-lancamento",
    icon: "🚨",
    title: "Lançamento próximo em Revisão",
    summary: "Marca badge URGENTE quando o lançamento é em < 7 dias e a campanha ainda está em Revisão.",
    rule: {
      name: "Badge URGENTE · lançamento < 7 dias",
      companyId: "all",
      module: "marketing",
      trigger: { type: "launch_date_near", days: 7 },
      action:  { type: "add_badge", badge: { label: "URGENTE", color: "#EF4444" } },
    },
  },
  {
    ...
    rule: {
      ...
      action:  { type: "add_badge", badge: { label: "Alto Investimento", color: "#F59E0B" } },
    },
  },
  {
    ...
    rule: {
      ...
      companyId: "all",
      module: "marketing",
      trigger: { type: "campaign_stage_change", toStage: "ao_vivo" },
  ...
  },
  {
    ...
    rule: {
      ...
      companyId: "all",
      module: "marketing",
      trigger: { type: "campaign_stage_change", stageId: "encerrado", days: 3 },
