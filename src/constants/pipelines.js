...
export const DEFAULT_PIPELINE_STAGES = Object.freeze([
  Object.freeze({ id: "prospeccao",   name: "Prospecção",    code: "G", color: NEUTRAL.slate,   probability: 10 }),
  Object.freeze({ id: "contato",      name: "Contato",       code: "F", color: "#0EA5E9",       probability: 20 }),
  Object.freeze({ id: "qualificacao", name: "Qualificação",  code: "E", color: "#1E4D8C",       probability: 35 }),
  Object.freeze({ id: "proposta",     name: "Proposta",      code: "D", color: "#7C3AED",       probability: 55 }),
