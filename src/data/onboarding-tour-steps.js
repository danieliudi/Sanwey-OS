...
export const ONBOARDING_TOUR_STEPS = [
  ...
  { id: "rh-bem-estar", icon: "💆", title: "Programas",
    blurb: "Massagem, avaliação física, palestra — com várias datas, vagas por horário e agendamento pelo QR code, igual reserva de restaurante." },
