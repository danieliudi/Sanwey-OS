...
export const VIDEO_TUTORIALS = {
  consultor: [
    ...
    { id: "v-c7", title: "Prestação de contas em lote", description: "Viagens & Despesas", duration: null, url: null,
      quickStart: { icon: "🧾", steps: ["Em 'Viagens & Despesas' → 'Minhas viagens', use '+ Nova prestação de contas' para criar um envelope com um título (ex: nome da viagem)", "Adicione despesas a ela pelo botão '+ Adicionar despesa' no card da prestação, ou escolha-a no campo 'Prestação de contas' ao lançar uma despesa nova", "Quando terminar, clique em 'Enviar prestação de contas' — depois de enviada, ela fica travada e só o gestor decide as despesas dali em diante", "Despesa sem prestação continua funcionando como 'avulsa', do jeito que já era"] } },
  ],
  vendedor: [
    ...
    { id: "v-v7", title: "Lista Pessoal: sua lista privada", description: "Lista Pessoal", duration: null, url: null,
      quickStart: { icon: "✅", steps: ["Já vem ativada por padrão — se quiser desligar, é em Configurações → Preferências → Recursos", "Alterne entre Lista, Kanban e Agenda no topo da tela — Kanban aceita arrastar o card entre colunas, igual aos outros quadros da plataforma", "Ao criar uma tarefa, escrever o prazo direto no título (\"amanhã 15h\", \"sexta\", \"dia 15\") preenche data e hora sozinho — dá pra marcar como recorrente (diária/semanal/mensal) e adicionar etiquetas", "Clique numa tarefa para abrir o card completo: checklist, anexos e um espaço pra notas, além de título e descrição editáveis a qualquer momento", "Tarefa com prazo pra hoje avisa pelo sino de notificações", "É 100% privada: nem gerente, nem admin, ninguém além de você vê o que está aqui"] } },
    { id: "v-v8", title: "Prestação de contas em lote", description: "Viagens & Despesas", duration: null, url: null,
      quickStart: { icon: "🧾", steps: ["Em 'Viagens & Despesas' → 'Minhas viagens', use '+ Nova prestação de contas' para criar um envelope com um título (ex: nome da viagem)", "Adicione despesas a ela pelo botão '+ Adicionar despesa' no card da prestação, ou escolha-a no campo 'Prestação de contas' ao lançar uma despesa nova", "Quando terminar, clique em 'Enviar prestação de contas' — depois de enviada, ela fica travada e só o gestor decide as despesas dali em diante", "Despesa sem prestação continua funcionando como 'avulsa', do jeito que já era"] } },
  ],
  gerente: [
    ...
    { id: "v-g9", title: "Lista Pessoal: sua lista privada", description: "Lista Pessoal", duration: null, url: null,
      quickStart: { icon: "✅", steps: ["Já vem ativada por padrão — se quiser desligar, é em Configurações → Preferências → Recursos", "Alterne entre Lista, Kanban e Agenda no topo da tela — Kanban aceita arrastar o card entre colunas, igual aos outros quadros da plataforma", "Ao criar uma tarefa, escrever o prazo direto no título (\"amanhã 15h\", \"sexta\", \"dia 15\") preenche data e hora sozinho — dá pra marcar como recorrente (diária/semanal/mensal) e adicionar etiquetas", "Clique numa tarefa para abrir o card completo: checklist, anexos e um espaço pra notas, além de título e descrição editáveis a qualquer momento", "Tarefa com prazo pra hoje avisa pelo sino de notificações", "É 100% privada: nem gerente, nem admin, ninguém além de você vê o que está aqui"] } },
    { id: "v-g10", title: "Aprovando prestações de contas em lote", description: "Viagens & Despesas", duration: null, url: null,
      quickStart: { icon: "✅", steps: ["Em 'Gestão' → 'Despesas pendentes de aprovação', despesas enviadas numa prestação aparecem agrupadas num card só, com o total e quantas despesas tem", "Use 'Aprovar tudo' para aprovar o grupo inteiro de uma vez — só fica disponível quando nenhuma despesa do grupo estiver sem comprovante acima do limite exigido", "Se alguma estiver bloqueada, use 'Ver e decidir' para decidir despesa por despesa, igual já era antes", "Na nova aba 'Categorias', defina o \"Limite de alerta\" por categoria — acima desse valor, comprovante vira obrigatório para aprovar; sem limite configurado, vale o padrão da plataforma (R$100)"] } },
  ],
};
