...
export const VIDEO_TUTORIALS = {
  consultor: [
    ...
    { id: "v-c6", title: "Lista Pessoal: sua lista privada", description: "Lista Pessoal", duration: null, url: null,
      quickStart: { icon: "✅", steps: ["Já vem ativada por padrão — se quiser desligar, é em Configurações → Preferências → 'Lista Pessoal'", "O item aparece no menu 'Meu Espaço', ao lado de Minhas Tarefas e Chat", "Alterne entre Lista (agrupada por Hoje / Esta semana / Sem data) e Kanban (A Fazer / Fazendo / Feito) no topo da tela", "Use o botão '+ Nova tarefa' para criar uma — só o título é obrigatório, prazo e prioridade são opcionais", "É 100% privada: nem gerente, nem admin, ninguém além de você vê o que está aqui"] } },
  ],
  vendedor: [
