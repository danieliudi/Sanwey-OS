...
export const VIDEO_TUTORIALS = {
  consultor: [
    ...
    { id: "v-c6", title: "Tarefas Pessoais: sua lista privada", description: "Tarefas Pessoais", duration: null, url: null,
      quickStart: { icon: "✅", steps: ["Ative em Configurações → Meu perfil → 'Tarefas Pessoais' — vem desligada por padrão, é sua escolha ligar", "O item aparece no menu 'Meu Espaço', ao lado de Minhas Tarefas e Chat", "Alterne entre Lista (agrupada por Hoje / Esta semana / Sem data) e Kanban (A Fazer / Fazendo / Feito) no topo da tela", "Use o botão '+ Nova tarefa' para criar uma — só o título é obrigatório, prazo e prioridade são opcionais", "É 100% privada: nem gerente, nem admin, ninguém além de você vê o que está aqui"] } },
  ],
  vendedor: [
    ...
    { id: "v-v6", title: "Usando o Chat interno", description: "Chat", duration: null, url: null,
      quickStart: { icon: "💬", steps: ["Clique em 'Chat' no menu lateral para ver canais da sua equipe e abrir conversas diretas — quem você pode chamar no privado segue a estrutura da empresa (seu setor, seu gestor ou quem responde a você)", "No campo de mensagem, use o ícone de carinha para abrir a paleta de emoji, ou o ícone de figurinha para mandar uma do pacote da empresa", "O ícone de clipe anexa um arquivo ou imagem — ele vira uma prévia antes de enviar, com um 'x' para remover se mudar de ideia", "Mensagens com linguagem imprópria não são enviadas — aparece um aviso na hora, visível só para quem escreveu", "Use os filtros no topo da lista (Todas/Não lidas/Canais/Diretas) para achar uma conversa mais rápido, e 'Arquivadas' para tirar uma conversa da lista sem apagar nada", "Segure o ícone de microfone para gravar um áudio, solte para enviar — arraste para o lado antes de soltar se quiser cancelar"] } },
    { id: "v-v7", title: "Tarefas Pessoais: sua lista privada", description: "Tarefas Pessoais", duration: null, url: null,
      quickStart: { icon: "✅", steps: ["Ative em Configurações → Meu perfil → 'Tarefas Pessoais' — vem desligada por padrão, é sua escolha ligar", "O item aparece no menu 'Meu Espaço', ao lado de Minhas Tarefas e Chat", "Alterne entre Lista (agrupada por Hoje / Esta semana / Sem data) e Kanban (A Fazer / Fazendo / Feito) no topo da tela", "Use o botão '+ Nova tarefa' para criar uma — só o título é obrigatório, prazo e prioridade são opcionais", "É 100% privada: nem gerente, nem admin, ninguém além de você vê o que está aqui"] } },
  ],
  gerente: [
    ...
    { id: "v-g9", title: "Tarefas Pessoais: sua lista privada", description: "Tarefas Pessoais", duration: null, url: null,
      quickStart: { icon: "✅", steps: ["Ative em Configurações → Meu perfil → 'Tarefas Pessoais' — vem desligada por padrão, é sua escolha ligar", "O item aparece no menu 'Meu Espaço', ao lado de Minhas Tarefas e Chat", "Alterne entre Lista (agrupada por Hoje / Esta semana / Sem data) e Kanban (A Fazer / Fazendo / Feito) no topo da tela", "Use o botão '+ Nova tarefa' para criar uma — só o título é obrigatório, prazo e prioridade são opcionais", "É 100% privada: nem gerente, nem admin, ninguém além de você vê o que está aqui"] } },
  ],
};
...
VIDEO_TUTORIALS.marketing = [
  ...
  { id: "v-mkt7", title: "Usando o Chat interno", description: "Chat", duration: null, url: null,
    quickStart: { icon: "💬", steps: ["Clique em 'Chat' no menu lateral para ver canais da sua equipe e abrir conversas diretas — quem você pode chamar no privado segue a estrutura da empresa (seu setor, seu gestor ou quem responde a você)", "No campo de mensagem, use o ícone de carinha para abrir a paleta de emoji, ou o ícone de figurinha para mandar uma do pacote da empresa", "O ícone de clipe anexa um arquivo ou imagem — ele vira uma prévia antes de enviar, com um 'x' para remover se mudar de ideia", "Mensagens com linguagem imprópria não são enviadas — aparece um aviso na hora, visível só para quem escreveu", "Use os filtros no topo da lista (Todas/Não lidas/Canais/Diretas) para achar uma conversa mais rápido, e 'Arquivadas' para tirar uma conversa da lista sem apagar nada", "Segure o ícone de microfone para gravar um áudio, solte para enviar — arraste para o lado antes de soltar se quiser cancelar"] } },
  { id: "v-mkt8", title: "Tarefas Pessoais: sua lista privada", description: "Tarefas Pessoais", duration: null, url: null,
    quickStart: { icon: "✅", steps: ["Ative em Configurações → Meu perfil → 'Tarefas Pessoais' — vem desligada por padrão, é sua escolha ligar", "O item aparece no menu 'Meu Espaço', ao lado de Minhas Tarefas e Chat", "Alterne entre Lista (agrupada por Hoje / Esta semana / Sem data) e Kanban (A Fazer / Fazendo / Feito) no topo da tela", "Use o botão '+ Nova tarefa' para criar uma — só o título é obrigatório, prazo e prioridade são opcionais", "É 100% privada: nem gerente, nem admin, ninguém além de você vê o que está aqui"] } },
];

// gerente_marketing herda este array inteiro (spread abaixo) — "Tarefas
// Pessoais" (v-mkt8) já vem junto, sem precisar duplicar aqui.
...
VIDEO_TUTORIALS.rh = [
  ...
  { id: "v-rh5", title: "Usando o Chat interno", description: "Chat", duration: null, url: null,
    quickStart: { icon: "💬", steps: ["Clique em 'Chat' no menu lateral para ver canais da sua equipe e abrir conversas diretas — quem você pode chamar no privado segue a estrutura da empresa (seu setor, seu gestor ou quem responde a você)", "No campo de mensagem, use o ícone de carinha para abrir a paleta de emoji, ou o ícone de figurinha para mandar uma do pacote da empresa", "O ícone de clipe anexa um arquivo ou imagem — ele vira uma prévia antes de enviar, com um 'x' para remover se mudar de ideia", "Mensagens com linguagem imprópria não são enviadas — aparece um aviso na hora, visível só para quem escreveu", "Use os filtros no topo da lista (Todas/Não lidas/Canais/Diretas) para achar uma conversa mais rápido, e 'Arquivadas' para tirar uma conversa da lista sem apagar nada", "Segure o ícone de microfone para gravar um áudio, solte para enviar — arraste para o lado antes de soltar se quiser cancelar"] } },
  { id: "v-rh6", title: "Tarefas Pessoais: sua lista privada", description: "Tarefas Pessoais", duration: null, url: null,
    quickStart: { icon: "✅", steps: ["Ative em Configurações → Meu perfil → 'Tarefas Pessoais' — vem desligada por padrão, é sua escolha ligar", "O item aparece no menu 'Meu Espaço', ao lado de Minhas Tarefas e Chat", "Alterne entre Lista (agrupada por Hoje / Esta semana / Sem data) e Kanban (A Fazer / Fazendo / Feito) no topo da tela", "Use o botão '+ Nova tarefa' para criar uma — só o título é obrigatório, prazo e prioridade são opcionais", "É 100% privada: nem gerente, nem admin, ninguém além de você vê o que está aqui"] } },
];

// gerente_rh herda este array inteiro (spread abaixo) — "Tarefas Pessoais"
