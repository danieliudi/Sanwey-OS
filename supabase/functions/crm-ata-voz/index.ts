...
// MD-06 (mesma regra do ai-assistant): a cota diária vale só pro fallback da
// chave da EMPRESA — chave pessoal não é limitada, o custo é do próprio dono.
// O contador de ai_org_quota_increment é um só por usuário/dia
// (ai_org_quota:<user>:<data>), compartilhado com o ai-assistant: são 50
// chamadas à IA da empresa por dia somando tudo, não 50 por function. Aqui
// isso pesa mais que no assistente de texto — cada ata com áudio passa pelo
// Whisper antes de estruturar, ou seja, duas chamadas pagas por gravação.
