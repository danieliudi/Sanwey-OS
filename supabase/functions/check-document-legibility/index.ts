...
//
// Commitada ao repositório em 19/08/2026 (achado AC-02 da auditoria de
// segurança): já estava ativa em produção sem nunca ter passado por code
// review nem ter histórico de versão. O código em si não tinha achado —
// commitado como estava.
